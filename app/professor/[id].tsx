...
const PROFESSORS_DATA: Professor[] = [
  {
    ...
    expertise: "Initiation Rites, Liminal States, Shadow Integration",
    bio: "Dr. Solstice guides practitioners through the liminal space between the old world and the new. With 20+ years of experience in depth psychology and mystical traditions, she specializes in helping seekers prepare for the journey ahead through sacred intention and purification.",
  ...
  },
  {
    ...
    title: "Master of the Mystic",
    gate: 12,
    gateName: "The Mystic",
    expertise: "Unity Consciousness, Transcendence, Source Connection",
    bio: "Ascended Master Azrael teaches the final mysteries — dissolution of the separate self and reunion with Source. His teachings integrate mystical Christianity, Buddhist emptiness, and the ultimate transformation that occurs when the individual merges with the infinite.",
